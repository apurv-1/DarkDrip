...
import { toggleNavOpen, toggleEditPanel } from '../../redux/reduxActions';
    ...
    <nav>
      ...
      <span>
        <button className="menu-button  hide-desktop">
          <img src={Burger} alt="menu" onClick={() => dispatch(toggleNavOpen())} />
        </button>
      ...
      {props.userRole === ROLES.BASIC ? (
        <li>
          <Link to="/become-admin">
            <img className="hide-desktop" alt="become admin" src={UpgrateToAdminIcon} />
