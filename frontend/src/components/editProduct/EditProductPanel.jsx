  ...
  return !editPanelState ? null : (
    <div
      ...
      <div className="edit-product-container">
        ...
        <button className="exit-edit-product" onClick={() => dispatch(toggleEditPanel())}>
            ...
            <div className="edit-product-flex-container">
              ...
              <div className="edit-product-right-panel">
                ...
                {userRole !== ROLES.MASTER ? null : (
                  <div className="is-default">
                    <input
                      ...
                      type="checkbox"
                      checked={isDefault}
                      onChange={() => setIsDefault((prev) => !prev)}></input>
                ...
                <select
                  ...
                  value={category}>
                  <option value={CATEGORIES.CANDY}>Candies</option>
                  <option value={CATEGORIES.DARK_CHOCOLATE}>Dark Chocolate</option>
                  <option value={CATEGORIES.MILK_CHOCOLATE}>Milk Chocolate</option>
                  <option value={CATEGORIES.WHITE_CHOCOLATE}>White Chocolate</option>
                </select>
              </div>
            </div>

            <div className="product-edit-buttons">
              <button onClick={() => dispatch(toggleEditPanel())} className="btn-secondary">
                CANCEL
              </button>
              <button
                type="submit"
